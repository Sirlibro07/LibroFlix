...
export default function AuthForm({
    ...
    return (
        <form
            ...
            className="auth_form w-full h-fit bg-black px-4 py-8 rounded-t-[1.875rem] lg:rounded-none lg:flex lg:flex-col lg:justify-center lg:px-10 lg:h-full lg:min-h-[100vh] lg:w-[37.5rem]"
        >
