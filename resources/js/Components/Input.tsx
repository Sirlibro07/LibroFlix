...
const Input = ({
    ...
    return (
        <input
            ...
            className={`w-full h-auth_input_btn bg-body text-contrast rounded-10 text-input border-2 border-border_color placeholder-light_color focus:border-border_color focus:ring-0  ${className}`}
        />
    );
};
