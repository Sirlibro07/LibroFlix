...
const MovieCardPlayButton = () => {
    ...
    return (
        <div className="opacity-0 transition-all duration-300 group-hover:opacity-100 absolute rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[45%] md:w-[35%]">
